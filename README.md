...
```javascript
float32ToUint32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-to-uint32@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-to-uint32@v0.2.1-umd/browser.js"></script>
```
