...
```javascript
import float32ToUint32 from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base-to-uint32@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-float32-base-to-uint32/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/number-float32-base-to-uint32/actions/workflows/test.yml?query=branch:v0.1.1
